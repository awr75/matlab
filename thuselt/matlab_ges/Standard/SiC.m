% Programm SiC.m
%*******************************************************
% m-File zur Eingabe der Materialparameter von 6H-SiC
%
...
EG = 2.86;              % Bandabstand bei 300 K in eV
epsrel = 10.2;				% relative DK
me = 0.6;		   		% effektive Masse des Leitungsbandes
mh = 1.0;					% effektive Masse des Valenzbandes
nue_e = 1;					% Zahl der Täler des Leitungsbandes
mye_i = 500;            % Elektronenbeweglichkeit im eigenleitenden Material bei 300 K
myh_i = 'nicht bekannt' ; % keine Daten zur Löcherbeweglichkeit im eigenleitenden Material
