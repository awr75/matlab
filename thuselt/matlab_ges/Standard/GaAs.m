% Programm GaAs.m
%*******************************************************
% m-File zur Eingabe der Materialparameter von GaAs
%
...
EG = 1.424;             % Bandabstand bei 300 K in eV
epsrel = 12.4;				% relative DK
me = 0.066;					% effektive Masse des Leitungsbandes
mh = 0.53;					% effektive Masse des Valenzbandes
nue_e = 1;					% Zahl der Täler des Leitungsbandes
mye_i = 8500;           % Elektronenbeweglichkeit im eigenleitenden Material bei 300 K
myh_i = 400;            % Löcherbeweglichkeit im eigenleitenden Material bei 300 K
