% Programm Germanium.m
%*******************************************************
% m-File zur Eingabe der Materialparameter von Germanium
%
...
EG = 0.66;              % Bandabstand bei 300 K in eV
epsrel = 15.4;				% relative DK
me = 0.22;					% effektive Masse des Leitungsbandes
mh = 0.36;					% effektive Masse des Valenzbandes
nue_e = 4;					% Zahl der Täler des Leitungsbandes
mye_i = 3900;           % Elektronenbeweglichkeit im eigenleitenden Material bei 300 K
myh_i = 1900;           % Löcherbeweglichkeit im eigenleitenden Material bei 300 K
