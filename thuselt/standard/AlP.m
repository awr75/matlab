% Programm AlP.m
%*******************************************************
% m-File zur Eingabe der Materialparameter von AlP
%
...
EG = 2.45;					% Bandabstand bei 300 K in eV
epsrel = 10.9;				% relative DK
me = 0.55;					% effektive Masse des Leitungsbandes
mh = 0.70;					% effektive Masse des Valenzbandes
nue_e = 3;					% Zahl der Täler des Leitungsbandes
mye_i = 80;             % Elektronenbeweglichkeit im eigenleitenden Material bei 300 K
myh_i = 'nicht bekannt'; % Löcherbeweglichkeit im eigenleitenden Material bei 300 K
