% Programm Silizium.m
%*******************************************************
% m-File zur Eingabe der Materialparameter von Silizium
%
...
EG = 1.12;              % Bandabstand bei 300 K in eV
epsrel = 11.4;				% relative DK
me = 0.32;					% effektive Masse des Leitungsbandes
mh = 0.57;					% effektive Masse des Valenzbandes
nue_e = 6;              % Zahl der Täler des Leitungsbandes
mye_i = 1340;           % Elektronenbeweglichkeit im eigenleitenden Material bei 300 K
myh_i = 461;            % Löcherbeweglichkeit im eigenleitenden Material bei 300 K
