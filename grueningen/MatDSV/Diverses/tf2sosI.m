function varargout = tf2sosI(B,A,varargin)
%TF2SOSI Transfer Function to Second Order Section conversion.
%
%    Same as tf2sos, but uses direct form I cascade blocks (see Bild 5.45):
%
%   -----b-Q------ ... ---b-Q--------
%      |   |   |        |   |   |
...
%
%   [SOS,G] = TF2SOSI(B,A) finds a matrix SOS in second-order sections 
...
%
%   TF2SOSI(B,A,DIR_FLAG) specifies the ordering of the 2nd order
...
%
%   TF2SOSI(B,A,DIR_FLAG,SCALE) specifies the desired scaling of the gain
...
%
%   See also TF2SOS, ZP2SOS, SOS2ZP, SOS2TF, SOS2SS, SS2SOS, CPLXPAIR.
%
%  Example 
%  -------
%  [b,a]=ellip(6,1,40,.2); sos=tf2sosI(b,a,'up','inf')
...
%     [4] D.Ch. von Grünigen, Digitale Signalverarbeitung, 
%              Fachbuchverlag Leipzig, 2004, Kapitel 6.4.5
%
%   Author: R. Losada 
...
[z,p,k] = tf2zp(B,A);
[varargout{1:nargout}] = zp2sosI(z,p,k,varargin{:});
